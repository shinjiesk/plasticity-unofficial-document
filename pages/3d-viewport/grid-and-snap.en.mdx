...
- You can also toggle and adjust grid snapping via commands in the Command Palette: **Grid: toggle grid snapping**, **Viewport: decrease grid size**, **Viewport: increase grid size**.
