...
The 3D view can be manipulated with the mouse.
...
- To snap to orthographic projection during rotation: 
   - Use <kbd>Alt</kbd> + middle button drag.
</div>
...
- To view it full screen: <kbd>/ (Slash)</kbd> or click the button ![Focus button](./img/button-focus.png) at the bottom left of the screen.
- To  view it full screen and hide all other objects: <kbd>. (period)</kbd>

## Switching the Display Mode

These buttons are located in the upper right corner of the screen.
![Render mode](./img/render-mode-etc.png)


<div class="dl">
- Toggle overlay display: 
   - This switches the grid display on and off.
   - <kbd>Alt - Shift - Z</kbd> or click the button ![Focus button](./img/button-focus.png) at the bottom left of the screen.
- Toggle transparency display: 
   - This makes hidden lines visible.
   - It also allows you to select hidden lines.
   - <kbd>Alt - Z</kbd> or click the button ![Focus button](./img/button-focus.png) at the bottom left of the screen.
</div>
