...
- (3) Group
    - Groups appear at the top of the outliner.
...
- (4) Toggle states
    ...
    - <ButtonIcon type="button-outliner-hide" double="true" />: Toggle hide in viewport
    - <ButtonIcon type="button-outliner-disable" double="true" /> : Toggle disable in viewport
    - <ButtonIcon type="button-outliner-disable-selection" double="true"  /> : Toggle disable selection in viewport
- (5) Collapse all
