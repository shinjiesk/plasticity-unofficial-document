...
1. Download the following two files:
    - <a href="/public/download_files/selection-mode.radial.json" download="aaa.json">selection-mode.radial.json</a>





    - [selection-mode.radial.json](/download_files/selection-mode.radial.json)
    - [viewport-settings.radial.json](/download_files/viewport-settings.radial.json)
...
For instance, we'll design a "My Menu" with "Spline Curve", "Bridge", and "Lock Selected", accessible via the shortcut <kbd>Ctrl + Shift + F</kbd>.
