...
- Right-click on a section label and choose "Select all" to select all objects within that section.
...
## Find Objects in the Outliner

- To display the object you've selected in the 3D viewport within the Outliner, click the "B" button at the top of the Outliner and choose "Scroll to selection." This will bring the selected object to the top of the Outliner.
