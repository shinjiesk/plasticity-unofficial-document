...
- Settings for using the 3Dconnexion SpaceMouse.
- The SpaceMouse confirmed to work are the SpaceMouse Compact and SpaceMouse Pro on Windows, and the SpaceMouse Compact on macOS. Operation on Linux is unconfirmed.
