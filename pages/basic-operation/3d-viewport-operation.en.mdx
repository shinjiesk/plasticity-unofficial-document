...
- Snap to orthographic projection when rotating: `Alt` + middle button drag.[<YoutubeExternalIcon />](https://youtu.be/Qxou-1xByuM)
...
- Display it full screen: `/`[<YoutubeExternalIcon />](https://youtu.be/E7JQs3lYATU)
