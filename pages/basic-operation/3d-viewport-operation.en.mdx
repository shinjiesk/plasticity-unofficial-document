...
- Snap to orthographic projection when rotating: `Alt` + middle button drag.<YoutubeExternalIcon url="https://youtu.be/Qxou-1xByuM"/>
...
- Display it full screen: `/`<YoutubeExternalIcon url="https://youtu.be/E7JQs3lYATU"/>
