...
- The Rebuild Curve command's Refit method has been enhanced to allow for keeping corners.
    ...
    . rebuild curve   rebuild curve w/ refit can now has "keep corners" or not #11
    . Fillet shell    Fillet shell has new keybinding to toggle tangent edges #13
    . Boolean         radio buttons for operation type (union, etc) #31
