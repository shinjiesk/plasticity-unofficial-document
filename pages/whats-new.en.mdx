...
#### Isolate #18
#### Thicken Face (which is called by Thicken automatically when a face is selected) #18
#### Selection: convert to groups    selects all items in same group #13
#### Project Outline Command (keybinding: alt-d when a solid/sheet is selected) #35
#### Create Outline Command #35
...
### Renamaed Commands and Deprecations

#### Renamed commands
- Explode renamed to Unjoin     Unjoin/Unjoin Curves/Unjoin Faces/Unjoin Sheiis  #33
- Delete renamed to Dissolve  (this should not affect you unless you have custom keybindings)

#### Deprecation
- Focus #18 (replaced by Isolate)