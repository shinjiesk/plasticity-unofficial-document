...
To use the Blender Bridge, it is necessary to install the add-on and activate the feature. For more details, refer [here](../blender/install-blender-addon.en.mdx).
