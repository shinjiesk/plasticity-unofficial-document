...
- `Numpad 7`: Use the XY plane. This gives you a top-down view.
- `Numpad 3`: Use the YZ plane. This gives you a view from the right.
- `Numpad 1`: Use the XZ plane. This gives you a front view.

### Creating a Construction Plane Aligned with a Surface

You can create a construction plane that aligns with the face of a solid or sheet. <YoutubeExternalIcon url="https://youtu.be/j0jyWmzZbpw" />
...
- If you don't want to change your view, press `Shift`+`Space` instead of `Space`.
