...
2. **Within Blender:**
    1. Ensure that the Blender Bridge add-on is installed and activated. Installation instructions can be found [here](./install-blender-addon).
    2. Click the "Connect" button in the Plasticity sidebar panel. Once a connection is established, additional options will be displayed in the panel.
    3. Click the "Refresh" button in the Plasticity sidebar panel to transfer objects from Plasticity to Blender.
    4. The transferred objects will appear in the 3D viewport of Blender.
