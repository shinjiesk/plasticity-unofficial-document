...
<Callout emoji="❗">
**Note**<br />
The guide endpoints must touch the profile curve. If they are touching, they will be green. Otherwise, they will be purple. To ensure a precise touch, see [**Object Snaps**](../3d-viewport/grid-and-snap#object-snap).
</Callout>
