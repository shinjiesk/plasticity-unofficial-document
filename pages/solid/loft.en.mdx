...
<Callout emoji="❗">
**Attention**<br />
The guide endpoints must be perfectly aligned on the profile curves. When they are perfectly aligned, the points will turn green. If they appear purple, they are not aligned. To ensure a precise alignment, see [**Object Snaps**](../3d-viewport/grid-and-snap#object-snap).
</Callout>
