...
4. Set the options in the command dialog and shortcut key.
   ...
   - <kbd>D</kbd> **Fillet Distance:** Specifies the fillet distance by moving the cursor.
   - <kbd>C</kbd> **Chanfer Distance:** Specifies the chanfer distance by moving the cursor.
