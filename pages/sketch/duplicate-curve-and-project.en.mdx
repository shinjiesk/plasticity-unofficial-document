...
3. Press the shortcut <kbd>Alt-D</kbd>.
4. The move gizmo appears and you can freely move the projected curve.
   - You can also limit the direction of movement.
           - <kbd>Shift-Z</kbd> : **Z plane** : Constrains to the Z plane.
     - <kbd>Shift-X</kbd> : **X plane** : Constrains to the X plane.
     - <kbd>Shift-Y</kbd> : **Y plane** : Constrains to the Y plane.
