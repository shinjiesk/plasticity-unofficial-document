...
## Limit to the coordinate axis direction[#limit-to-the-coordinate-axis-direction]

- By pressing <kbd>X</kbd>,<kbd>Y</kbd>,<kbd>Z</kbd> key, you can limit the cursor movement to the cordinate axis direction.

![Sketching Tips 4](/img/sketching-tips-4.gif)

## Add edges to the position of the curve to be created[#add-edges-to-the-position-of-the-curve-to-be-created]

- By presssing <kbd>K</kbd> key, edges can be added to the position of the curve to be created..
